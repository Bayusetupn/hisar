...
const ProfileOverview = () => {
  ...
  const agen = async() =>{
    try {
      await api.get(`/ustad/me`, {withCredentials: true}).then((res)=>{
    ...
    <div className="flex w-full flex-col h-screen overflow-y-scroll gap-5 p-5 dark:!bg-navy-900">
      ...
      <div className="w-ful mt-3 flex h-fit flex-col gap-5 lg:grid lg:grid-cols-12">
        <div className="col-span-3 lg:!mb-0">
          <Banner ktp={dataAgen.no_ktp} id={dataAgen.id} gabung={dataAgen.bergabung} foto={dataAgen.foto} nama={dataAgen.nama} alamat={dataAgen.alamat} no={dataAgen.no_telepon} username={dataAgen.username}/>
        </div>
